...
def admin_approve_mechanic_view(request):
    ...
    mydict={'mechanics':mechanics}
    return render(request,'admin_approve_mechanic.html',context=mydict)
...
def admin_view_mechanic_view(request):
    ...
    mydict={'mechanics':mechanics}
    return render(request,'admin_view_mechanic.html',context=mydict)
